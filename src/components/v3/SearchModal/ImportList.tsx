            ...
            <PaddedColumn gap='md'>
                <AutoColumn gap='md'>
                    ...
                    <Card style={{ backgroundColor: transparentize(0.8, theme.red1) }}>
                        <AutoColumn justify='center' style={{
                            textAlign: 'center',
                            gap: '16px',
                            marginBottom: '12px'
                        }}>
                        ...
                        <AutoColumn
                            ...
                            <TYPE.body fontWeight={500} color={theme.red1}>
                                <Trans>
                                    ...
                                    correct. Anyone can create a list,
                                    including creating fake versions of existing lists and lists
                                    that claim to represent projects that do
                                    not have one.
                                </Trans>
                            </TYPE.body>
                            <TYPE.body fontWeight={600} color={theme.red1}>
                                <Trans>If you purchase a token from this list, you may not be able
                                    to sell it back.</Trans>
                            </TYPE.body>
                        </AutoColumn>
                        <AutoRow justify='center' style={{ cursor: 'pointer' }}
                            ...
                            />
                            <TYPE.body ml='10px' fontSize='16px' color={theme.red1}
                                       fontWeight={500}>
                    ...
                    {addError ? (
                        <TYPE.error title={addError}
                                    style={{ textOverflow: 'ellipsis', overflow: 'hidden' }} error>
                            {addError}
                        </TYPE.error>
                    ) : null}
                </AutoColumn>
