...
import { EXCHANGE_FACTORY_ADDRESS_MAPS, EXCHANGE_PAIR_INIT_HASH_MAPS, V2Exchanges, V2_FACTORY_ADDRESSES } from 'constants/v3/addresses'
import { useActiveWeb3React } from 'hooks'
import flatMap from 'lodash.flatmap'
import { BASES_TO_TRACK_LIQUIDITY_FOR, PINNED_PAIRS } from 'constants/v3/routing'
...
export function useV2Pairs(currencies: [Currency | undefined, Currency | undefined][], v2Exchange: V2Exchanges = V2Exchanges.Quickswap): [PairState, Pair | null][] {
...
export function useV2Pair(tokenA?: Currency, tokenB?: Currency, exchange: V2Exchanges = V2Exchanges.Quickswap): [PairState, Pair | null] {
